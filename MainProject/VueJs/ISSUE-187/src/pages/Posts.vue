<template>
  <div class="row">
    <div class="col-md-8 ">
      ...
      <div class="text-end">
        <router-link to="/posts/create-post"><button class="btn btn-primary mb-3">Create Post</button></router-link>
        <!-- <PostItem></PostItem> -->
      </div>
      <table class="table table-dark table-striped table-hover">
        ...
        <tbody>
          <tr v-for="post in postsData" :key="post.id">
            ...
            <td>{{ post.name }}</td>
            <td>
              <router-link :to="`/posts/${post.id}`">Show Post Details</router-link>
            </td>
          </tr>
        </tbody>
      </table>
